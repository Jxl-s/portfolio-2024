...
const projects: Project[] = [
	{
		...
		desc: [
			{
				en: "Won <b>2nd</b> place as a solo team among <b>800+</b> participants in ConUHacks IX, which is the largest hackathon in Quebec.",
				fr: "Gagné <b>2e</b> place en tant qu'équipe solo parmi plus de <b>800</b> participants à ConUHacks IX, le plus grand hackathon du Québec.",
			},
			{
				en: "Developed a multiplayer game, where users explain code instead of writing code, powered by OpenAI's GPT-4o model.",
				fr: "Développé un jeu multijoueur, où les utilisateurs expliquent du code au lieu d'écrire du code, alimenté par le modèle GPT-4o d'OpenAI.",
			},
		],
